...
const App = () => {
    ...
    return (
        <div className="min-h-screen p-6 bg-sw-blue-light flex flex-col items-center">
            <h1 className="text-2xl font-bold mb-4 text-sw-brown-dark text-center">Time and Space Navigator: A Star Wars Journey</h1>
            <p className="mb-4 text-sw-brown-dark max-w-4xl text-center">
